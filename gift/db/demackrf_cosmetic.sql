...
-- Üretim Zamanı: 15 May 2025, 23:17:00
...
INSERT INTO `kullanicilar` (`kullanici_id`, `ad_soyad`, `email`, `sifre`, `kayit_tarihi`, `adres`, `telefon`) VALUES
(4, 'Ayşe Yılmaz', 'ayseyilmaz@gmail.com', '$2y$10$cFz65it8aMzv3J2jyJFlBuu.HT3Z9QmHZ4fYbfafSumRszOedPG8C', '2025-05-13 14:20:55', '6546şuıgıugıl', '(654) 984 64 65'),
(5, 'Esma Kaya', 'esmakaya@gmail.com', '$2y$10$5/lDuqMPAZTpAciWoyJok.WMMS6/9KrWG1uMB5VELnZO5Z55suNfa', '2025-05-13 22:28:17', NULL, ''),
(6, 'Merve Şen', 'merven@gmail.com', '$2y$10$1o5AinXLiNKAoywSPRK/VOYkHsYw//gHqJWmdVVBDoBOKLQrwRg.e', '2025-05-14 12:51:59', '', '(555) 555 55 55'),
(7, 'aysecik', 'ayse@gmail.com', '$2y$10$E/R9kahI0DwVaafyfAJasue.ASBPApNCekjne0ayWsxBm3/R3Fd9.', '2025-05-14 13:15:48', NULL, ''),
(8, 'Merve Şen', 'merve@gmail.com', '$2y$10$pDSvVoyIypPTOrTUiUk0wOky04BpOkmKVcNoU/RVhpxxtHQi.kOXy', '2025-05-15 19:15:22', '', ''),
(9, 'Elif Karaçam', 'Elifkaracam985@gmail.com', '$2y$10$nvLOggZonkqius9Khf10fuVCfBb3T0aH.Itx7umRlxfLHp.F4o1mu', '2025-05-15 19:16:12', 'Mollo gürani mahalle rahmet çıkmaz sokak nur apartmanı a blok no 4/4 istanbul/fatih', '(123) 445 67 88'),
(10, 'Samet DER', 'dersamet4@gmail.com', '$2y$10$jiYyzpP8isLgn96iylirsO1QywzgRSKHVQyZY1WdTtbp5/gXSA9H6', '2025-05-15 20:15:49', NULL, NULL);
...
INSERT INTO `sepet` (`sepet_id`, `kullanici_id`, `urun_id`, `urun_adi`, `urun_fiyat`, `miktar`, `eklenme_tarihi`) VALUES
(74, 1, 1, 'Afterglow Liquid Blush', 1720.00, 1, '2025-05-15 18:25:28'),
(75, 1, 27, 'Easy Bake Loose - Sabitleyici Pudra', 2169.00, 1, '2025-05-15 18:41:59');
...
INSERT INTO `siparisler` (`kullanici_id`, `urun_adi`, `urun_adet`, `toplam_fiyat`, `siparis_tarihi`, `ad_soyad`, `email`, `telefon`, `adres`, `odeme_yontemi`, `durum`, `siparis_id`) VALUES
(6, 'Light Reflecting Foundation', 2, 4760.00, '2025-05-14 13:13:25', 'Merve Şen', 'merven@gmail.com', '555-555-55-55', 'rtyuıoş', 'kredi_karti', 'Yeni', 1),
(6, 'LES 4 OMBRES', 1, 2450.00, '2025-05-14 13:13:25', 'Merve Şen', 'merven@gmail.com', '555-555-55-55', 'rtyuıoş', 'kredi_karti', 'Yeni', 1),
(6, 'MAKE ME BLUSH', 1, 2100.00, '2025-05-14 13:13:25', 'Merve Şen', 'merven@gmail.com', '555-555-55-55', 'rtyuıoş', 'kredi_karti', 'Yeni', 1),
(7, 'Climax Extreme', 1, 1420.00, '2025-05-14 13:16:43', 'aysecik', 'ayse@gmail.com', '545212', 'dfghjklş', 'kapida_odeme', 'Yeni', 2),
(7, 'All Hours - Uzun Süre Kalıcı Aydınlık Mat Bitişli Fondöten', 1, 2750.00, '2025-05-14 13:16:43', 'aysecik', 'ayse@gmail.com', '545212', 'dfghjklş', 'kapida_odeme', 'Yeni', 2),
(7, 'Dior Addict Lip Maximizer', 1, 1690.00, '2025-05-14 13:16:43', 'aysecik', 'ayse@gmail.com', '545212', 'dfghjklş', 'kapida_odeme', 'Yeni', 2),
(7, 'YSL Loveshine', 2, 3920.00, '2025-05-14 13:32:29', 'aysecik', 'ayse@gmail.com', '555-555-55-55', 'sdfghjklş', 'kapida_odeme', 'Yeni', 3),
(7, 'Almost Lipstick Black Honey', 1, 980.00, '2025-05-14 13:32:29', 'aysecik', 'ayse@gmail.com', '555-555-55-55', 'sdfghjklş', 'kapida_odeme', 'Yeni', 3),
(6, 'Dior Addict Lip Maximizer', 1, 1690.00, '2025-05-14 13:40:02', 'Merve Şen', 'merven@gmail.com', '555-555-55-55', 'dfghjkl', 'kapida_odeme', 'Teslim Edildi', 4),
(6, 'ROUGE ALLURE', 1, 1900.00, '2025-05-14 13:40:02', 'Merve Şen', 'merven@gmail.com', '555-555-55-55', 'dfghjkl', 'kapida_odeme', 'Teslim Edildi', 4),
(4, 'Almost Lipstick Black Honey', 1, 980.00, '2025-05-14 17:02:22', 'Ayşe Yılmaz', 'ayseyilmaz@gmail.com', '46565165', 'ikfjngilbkngfslxcv', 'kredi_karti', 'Yeni', 5),
(4, 'Almost Lipstick Black Honey', 1, 980.00, '2025-05-14 17:03:30', 'Ayşe Yılmaz', 'ayseyilmaz@gmail.com', '65456546465', 'ilekdnfcviednkvsöçc x', 'kredi_karti', 'Kargoya Verildi', 6),
(4, 'Explicit Lipstick - Saten Bitişli Uzun Süre Kalıcı Ruj', 1, 1900.00, '2025-05-14 18:04:28', 'Ayşe Yılmaz', 'ayseyilmaz@gmail.com', '5423181867', 'istanbul avcılar, üniversite mah. sarıgül sokak no:18', 'kredi_karti', 'Teslim Edildi', 7),
(4, 'Dior Addict Lip Maximizer', 1, 1690.00, '2025-05-14 18:04:28', 'Ayşe Yılmaz', 'ayseyilmaz@gmail.com', '5423181867', 'istanbul avcılar, üniversite mah. sarıgül sokak no:18', 'kredi_karti', 'Teslim Edildi', 7),
(4, 'Climax Extreme', 1, 1420.00, '2025-05-14 20:12:39', 'Ayşe Yılmaz', 'ayseyilmaz@gmail.com', '5468498646531', 'şoışfjdgvşosdjovkl', 'kredi_karti', 'Yeni', 8),
(9, 'Light Reflecting Foundation', 2, 4760.00, '2025-05-15 19:17:05', 'Elif Karaçam', 'Elifkaracam985@gmail.com', '(053) 656 21 76', 'Mollo gürani mahalle rahmet çıkmaz sokak nur apartmanı a blok no 4/4 istanbul/fatih', 'kredi_karti', 'Teslim Edildi', 9),
(8, 'Soft Pinch - Likit Allık', 1, 1539.00, '2025-05-15 19:27:00', 'Merve Şen', 'merve@gmail.com', '555', 'fghjkl', 'kapida_odeme', 'Kargoya Verildi', 10),
(4, 'Climax Extreme', 1, 1420.00, '2025-05-15 20:10:17', 'Ayşe Yılmaz', 'ayseyilmaz@gmail.com', '(654) 984 64 65', '6546şuıgıugıl', 'kredi_karti', 'Kargoya Verildi', 11),
(4, 'Light Reflecting Foundation', 1, 2380.00, '2025-05-15 20:10:17', 'Ayşe Yılmaz', 'ayseyilmaz@gmail.com', '(654) 984 64 65', '6546şuıgıugıl', 'kredi_karti', 'Kargoya Verildi', 11);
...
INSERT INTO `yorumlar` (`yorum_id`, `urun_id`, `kullanici_id`, `yorum`, `puan`, `tarih`, `durum`) VALUES
(1, 37, 8, 'O kadar güzel kii aşık oldum resmen', 5, '2025-05-15 19:26:16', 'Onaylı'),
(2, 2, 4, 'harika', 1, '2025-05-15 20:08:59', 'Onaysız'),
(3, 2, 4, 'harika', 1, '2025-05-15 20:09:05', 'Onaysız'),
(4, 2, 4, 'harika', 1, '2025-05-15 20:09:16', 'Onaysız'),
(5, 5, 9, 'Harikaaa', 5, '2025-05-15 20:10:00', 'Onaylı'),
(6, 5, 9, 'Harikaaa', 5, '2025-05-15 20:10:30', 'Onaysız');
