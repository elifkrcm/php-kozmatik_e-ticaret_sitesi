...
// Ürünleri sorgula
$sql = "SELECT * FROM urunler LIMIT 12";
...
$username = "demackrf_demackrf";
$password = "Quosp069";
$dbname = "demackrf_cosmetic";
$port = 3306;

// Bağlantıyı kur
$baglanti = new mysqli($servername, $username, $password, $dbname, $port);
...
// Ürünleri çek
$stmt = $baglanti->prepare("SELECT * FROM urunler LIMIT 12");
$stmt->execute();
...
if ($sonuc->num_rows > 0) {
    while ($row = $sonuc->fetch_assoc()) {
        ...
        $puanStmt->execute();
        $puanSonuc = $puanStmt->get_result();
        $puanlar = $puanSonuc->fetch_assoc();
        $ortalama_puan = $puanlar['average_rating'] ? round($puanlar['average_rating'], 1) : 0;

        // Yıldızları göster
        echo "<div class='stars'>";
        for ($i = 0; $i < floor($ortalama_puan); $i++) {
            echo "<i class='fa fa-star'></i>";
        }
        if ($ortalama_puan - floor($ortalama_puan) >= 0.5) {
            echo "<i class='fa fa-star-half-o'></i>";
        }
        for ($i = 0; $i < (5 - ceil($ortalama_puan)); $i++) {
...
<br>
	  <div class="kategori-form" style="margin-left: 580px;">
	  <a href="shop.php">
              <button>
        ...
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                Ürünlerinizi en hızlı şekilde teslim etmek için sürekli olarak lojistik süreçlerimizi iyileştiriyoruz.<br><br>
              </p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                Alışverişinizde ücretsiz kargo avantajından yararlanarak, ürünlerinizi ek bir ücret ödemeden kapınıza kadar teslim alabilirsiniz.
              </p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                En iyi kaliteyi sunarak, her ürünümüzde üstün işçilik ve malzeme kullanımıyla müşteri memnuniyetini ön planda tutuyoruz.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-7">
            <div class="detail-box">
              ...
              <p>
                Her kadının hoşuna gidecek en iyi hediye seçeneği şüphesiz kozmetik ürünleridir. Hayatınızdaki kadınların değerini bilin. Değerli hissettirin.
              </p>
              <div class="btn-box">
